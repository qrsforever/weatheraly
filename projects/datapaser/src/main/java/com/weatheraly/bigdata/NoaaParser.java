...
public class NoaaParser {
    ...
    public static final int DIRECTION_ANGLE = 1;
    public static final int WIND_SPEED_RATE = 2;
    public static final int SKY_HEIGHT_DIM = 3;
    public static final int SKY_DISTANCE_DIM = 4;
    public static final int AIR_TEMPERATURE = 5;
    ...
    public String toString() {
        return "stationId: " + stationId
            ...
            + " directionAngleQuality: " + directionAngleQuality
            + " windSpeedRate: " + windSpeedRate
            + " windSpeedRateQuality: " + windSpeedRateQuality
            + " skyHeightDimension: " + skyHeightDimension
            + " skyHeightDimensionQuality: " + skyHeightDimensionQuality
            + " skyDistanceDimension: " +  skyDistanceDimension
            + " skyDistanceDimensionQuality: " + skyDistanceDimensionQuality
